          ...
          <Row className="justify-content-md-center">
            ...
            <Col xs={12} md={6}>
              ...
              <p>
                ...
                develop your software but help you set your direction right to
                get the most out of your software because only then technology
                would serve humanity to achieve it's full potential.
              </p>
            </Col>
          </Row>
        </Container>
